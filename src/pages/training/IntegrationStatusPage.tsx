          ...
          <div className="divide-y divide-slate-100 text-xs">
            <div className="p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="font-mono text-slate-800 font-semibold">/api/v1/external/learners</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-slate-500">Learner profiles & ULI retrieval</span>
            ...
            <div className="p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Badge className="bg-slate-100 text-slate-700 font-mono">GET</Badge>
                <span className="font-mono text-slate-800 font-semibold">/api/v1/external/programs</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-slate-500">CTPR & program offerings</span>
                <Badge className="bg-emerald-100 text-emerald-800 border-none">200 OK</Badge>
              </div>
            </div>
            <div className="p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Badge className="bg-slate-100 text-slate-700 font-mono">GET</Badge>
                <span className="font-mono text-slate-800 font-semibold">/api/v1/external/completions</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-slate-500">Unit competency completion transcripts</span>
                <Badge className="bg-emerald-100 text-emerald-800 border-none">200 OK</Badge>
              </div>
            </div>
          </div>
