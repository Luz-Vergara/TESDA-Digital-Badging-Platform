...
import { Shield, User, Building2, Briefcase, Lock, FileCheck, LayoutDashboard, LogOut, HelpCircle } from 'lucide-react';
...
export default function Login() {
  ...
  const { user, userProfile, isAuthReady, logout } = useFirebase();
  ...
  // Auto-redirect when authentication and profile initialization are ready
  useEffect(() => {
  ...
  }, [user, userProfile, isAuthReady, navigate]);
  ...
  const handleDemoLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // FirebaseProvider onAuthStateChanged will set userProfile & isAuthReady,
      // and the auto-redirect effect will safely navigate once profile is ready.
    } catch (error: any) {
