...
export const MOCK_BADGES: BadgeMetadata[] = [
  ...
  },
  {
    ...
    badgeType: 'Expert',
    description: 'Awarded for completion of the full Web Development training program.',
    issuer: 'TESDA Training Center - Manila',
    badgeHolder: 'Juan Dela Cruz',
    criteria: 'Completion of all modules in the Web Development training program',
    issuanceDate: '2023-08-20',
    verificationId: 'V-WD-2023-045',
    validity: 'Permanent',
    alignment: 'Institutional Standard',
    tags: ['Web', 'Programming', 'Frontend'],
    standards: ['HTML5/CSS3', 'JavaScript Basics'],
    status: 'Active',
  ...
  {
    id: 'B-003',
    programName: 'JavaScript Unit of Competency',
    badgeType: 'Proficient',
    description: 'Demonstrates proficiency in basic JavaScript programming.',
    issuer: 'TESDA Training Center - Manila',
    badgeHolder: 'Juan Dela Cruz',
    criteria: 'Passed institutional assessment for JavaScript module',
